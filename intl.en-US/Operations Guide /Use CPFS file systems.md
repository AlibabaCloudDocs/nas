# Use CPFS file systems {#concept_cyg_wng_4gb .concept}
...
```
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/147136/155719934941321_en-US.png)
    ...
    -   Open the `/etc/cpfs/cpfs-mounts.conf` configuration file, and add
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/147136/155719934941331_en-US.png)
