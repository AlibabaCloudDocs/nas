...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706387613110_zh-CN.png)

## 操作步骤 {#section_azs_osl_rod .section}

通过如下操作，可实现在任何一台连接公网的 PC（Windows 或 Linux）挂载 NAS，实现文件的上传和下载。

1.  在 NAS 控制台创建文件系统，详情请参见[创建文件系统](../../../../cn.zh-CN/控制台用户指南/管理文件系统.md#section_5jo_0kj_jn5)。
2.  为文件系统添加挂载点，且需要创建 VPC 挂载点（NAT 只支持 VPC） ，详情请参见[添加挂载点](../../../../cn.zh-CN/控制台用户指南/管理挂载点.md#section_6xi_a3u_zkq)。
3.  获得挂载点的 IP。 

    可以在 ECS 中 ping 挂载点地址获得 IP。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706387713114_zh-CN.png)

4.  在 NAT 控制台创建 NAT 网关，详情请参见[创建NAT网关](../../../../cn.zh-CN/用户指南/管理NAT网关/创建NAT网关.md#) 。 
5.  为 NAT 网关添加带宽包。
6.  创建 DNAT。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706387813118_zh-CN.png)

7.  验证挂载 NFS，将 NAT 映射配置到一个 NFS 的挂载点。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706387913119_zh-CN.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706387913120_zh-CN.png)

8.  验证挂载 SMB，删除原来的 NAT 映射，添加一条映射配置到一个 SMB 的挂载点。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706388013121_zh-CN.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18706/156706388013122_zh-CN.png) 
