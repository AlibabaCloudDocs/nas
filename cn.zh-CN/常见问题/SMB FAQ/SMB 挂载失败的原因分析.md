...
1.  使用ping 命令检查挂载点地址是否可连通，延时是否正常。
    ...
    -   若网络 ping 不通，请从以下方面排查。
        ...
        -   确认文件系统类型为 SMB。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149028/156506300441401_zh-CN.png)
...
3.  启用 TCP/IP NetBIOS Helper 服务，具体操作请参见[手动挂载SMB文件系统](../../../../cn.zh-CN/控制台用户指南/挂载文件系统/手动挂载SMB文件系统.md#)。
...
启动如下服务，具体操作可参见[挂载SMB文件系统](../../../../cn.zh-CN/控制台用户指南/挂载文件系统/手动挂载SMB文件系统.md#section_zlq_3j1_dfb)。
