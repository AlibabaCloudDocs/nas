...
2.  打开命令行窗口，执行以下命令挂载文件系统。
    ...
    -   挂载点域名：指创建文件系统挂载点时，自动生成的挂载点域名。挂载点详情请参见[管理挂载点](../../../../cn.zh-CN/控制台用户指南/管理挂载点.md#)。
...
3.  执行`net use`命令，检查挂载结果。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156410744449545_zh-CN.png)
