...
3.  在需要创建文件系统的地域，已有可用的云服务器ECS。
    ...
    **说明：** 
    ...
    2.  开通NAS服务后，默认的计费方式是按量付费。如果您想使用更优惠的套餐，可购买存储包，详情请参见[购买存储包](../../../../cn.zh-CN/计费方式/预付费/购买存储包.md#)。
...
2.  执行`mount -l`命令，查看挂载结果。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21207/156266616549539_zh-CN.png)
