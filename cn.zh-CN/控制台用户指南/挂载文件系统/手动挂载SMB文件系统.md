...
3.  确保Windows系统服务中的以下两项服务均已启动。
    -   Workstation
        ...
        2.  在服务中找到 Workstation，确认运行状态为**已启动**，启动类型为**自动**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156506295842055_zh-CN.png)
    ...
    -   TCP/IP NetBIOS Helper
        ...
        3.  在高级TCP IP设置对话框中，选择 **WINS** \> **启用 TCP/IP 上的 NetBIOS**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156506295842056_zh-CN.png)
        ...
        5.  在服务中找到 TCP/IP NetBIOS Helper，确认运行状态为**已启动**，启动类型为**自动**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156506295954417_zh-CN.png)
...
3.  执行`net use`命令，检查挂载结果。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156506295949545_zh-CN.png)
