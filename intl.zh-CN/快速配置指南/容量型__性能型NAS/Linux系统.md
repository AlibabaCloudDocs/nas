...
1.  已注册阿里云账号，并完成实名认证。
    ...
    如果没有，请先注册阿里云账号，详情请参见[阿里云账号注册流程](../../../../intl.zh-CN/.md#)。
...
3.  在需要创建文件系统的地域，已有可用的云服务器ECS。
    ...
    **说明：** 
    ...
    1.  如果您要使用RAM账户操作NAS，详情请参见[RAM用户访问控制](../../../../intl.zh-CN/用户指南/权限管理/RAM用户访问控制.md#)。
...
**说明：** 初始情况下，每个账号都会自动生成一个VPC默认权限组，允许同一VPC环境下的任何IP地址都可以通过该挂载点访问文件系统。如果你要创建权限组，详情请参见[管理权限组](../../../../intl.zh-CN/用户指南/管理权限组.md#)。
...
1.  挂载NFS文件系统。
 ...
 |
    ...
    |挂载选项| 挂载文件系统时，可选择多种挂载选项，详情请参见[手动挂载NFS文件系统](intl.zh-CN/快速配置指南/挂载文件系统/手动挂载NFS文件系统.md#)中的[挂载选项说明表](intl.zh-CN/快速配置指南/挂载文件系统/手动挂载NFS文件系统.md#table_2uc_odz_vk9)。
...
2.  执行`mount -l`命令，查看挂载结果。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21207/156264039949539_zh-CN.png)
