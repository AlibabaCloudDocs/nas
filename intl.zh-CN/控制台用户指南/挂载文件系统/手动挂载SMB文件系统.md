# 手动挂载SMB文件系统 {#concept_zb5_1rh_cfb .concept}
...
3.  确保Windows系统服务中的以下两项服务均已启动。
    -   Workstation
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156438401542055_zh-CN.png)
    ...
    -   TCP/IP NetBIOS Helper
        ...
        3.  在高级TCP IP设置对话框中，选择 **WINS** \> **启用 TCP/IP 上的 NetBIOS**。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156438401642056_zh-CN.png)
...
3.  执行`net use`命令，检查挂载结果。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21209/156438401649545_zh-CN.png)
